...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2024 a las 16:04:06
...
INSERT INTO `usuarios` (`ID_Usuario`, `Nombre_Usuario`, `Dirección`, `Teléfono`) VALUES
...
ALTER TABLE `prestamos_usuarios`
  ...
  ADD CONSTRAINT `prestamos_usuarios_ibfk_2` FOREIGN KEY (`ID_Usuario`) REFERENCES `prestamos` (`ID_usuario`);
--
...
CREATE TABLE `cursos_asignados` (
  `ID_Cursos_asignados` int(11) NOT NULL,
...
INSERT INTO `estudiantes` (`ID_Estudiante`, `Nombre_Estudiante`, `Direccion`, `Cursos`) VALUES
(1, 'Juan Pérez', 'Calle Falsa 123', 'Matemáticas, Física, Química'),
(2, 'Ana López', 'Avenida Siempre Viva 742', 'Historia, Literatura');
...
--
-- Indices de la tabla `cursos_asignados`
--
ALTER TABLE `cursos_asignados`
  ADD PRIMARY KEY (`ID_Cursos_asignados`),
...
--
-- AUTO_INCREMENT de la tabla `cursos_asignados`
--
ALTER TABLE `cursos_asignados`
  MODIFY `ID_Cursos_asignados` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `cursos_asignados`
  ADD CONSTRAINT `cursos_asignados_ibfk_1` FOREIGN KEY (`ID_estudiante`) REFERENCES `estudiantes` (`ID_Estudiante`),
  ADD CONSTRAINT `cursos_asignados_ibfk_2` FOREIGN KEY (`ID_curso`) REFERENCES `cursos` (`ID_Curso`),
  ADD CONSTRAINT `cursos_asignados_ibfk_3` FOREIGN KEY (`ID_docente`) REFERENCES `docentes` (`ID_Docente`);
--
...
('root', '[{\"db\":\"Biblioteca\",\"table\":\"Prestamos\"},{\"db\":\"biblioteca\",\"table\":\"Libros\"},{\"db\":\"Biblioteca\",\"table\":\"Libros\"},{\"db\":\"biblioteca\",\"table\":\"autores\"},{\"db\":\"biblioteca\",\"table\":\"libros\"},{\"db\":\"Biblioteca\",\"table\":\"libros\"},{\"db\":\"Biblioteca\",\"table\":\"prestamos\"},{\"db\":\"biblioteca\",\"table\":\"prestamos\"},{\"db\":\"empresa\",\"table\":\"empleados\"},{\"db\":\"empresa\",\"table\":\"cargo\"}]');
...
('root', '2024-11-20 14:59:26', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
